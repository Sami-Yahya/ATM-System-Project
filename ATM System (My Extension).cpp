...
// Same previous project, after Adding Client Info Card and Update their Info
...
enum enMainMenuOptions { eShowInfo = 1, eQuickWithdraw = 2, eNormalWithdraw = 3, 
    eDeposit = 4, eCheckBalance = 5, eUpdateInfo = 6, eExit = 7 };
...
bool UpdateClientsByAccountNumber(string AccountNumber, vector<sClient>& vClients)
{
    ...
    if (FindClientByAccountNumber(AccountNumber, vClients, Client))
    {
        ...
        cout << "\n\nAre you sure you want to update your info? [Y/N]: ";
        cin >> Answer;
        ...
        if (toupper(Answer) == 'Y')
        {
            ...
            cout << "\n\nYour Info Updated Successfully." << endl;
            return true;
        }
    }
    else
...
void ShowClientInfoCardScreen()
{
    ...
    FindClientByAccountNumber(CurrentClient.AccountNumber, vClients, foundClient);
...
void ShowUpdateClientInfoScreen()
{
    system("cls");
    cout << "--------------------------------------------\n";
    cout << "\t     Update Your Info\n";
    cout << "--------------------------------------------\n";

    vector<sClient> vClients = LoadClientDataFromFile(ClientsFileName);
    UpdateClientsByAccountNumber(CurrentClient.AccountNumber, vClients);
}
...
void PerformMainMenuOption(enMainMenuOptions MainMenuOption)
{
    ...
    {
    case::enMainMenuOptions::eShowInfo:
    {
        system("cls");
        ShowClientInfoCardScreen();
        GoBackToMainMenu();
        break;
    }
    ...
    case::enMainMenuOptions::eUpdateInfo:
    {
        system("cls");
...
{
    system("cls");
    cout << "\t     Welcom, " << CurrentClient.Name << endl << endl;
    cout << "==============================================\n";
